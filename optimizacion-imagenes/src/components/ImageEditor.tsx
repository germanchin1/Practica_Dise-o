...
const ImageEditor = () => {
    ...
    const applyFilter = (filter: string) => {
        ...
        img.src = image;
        img.onload = () => {
            // Resize for display if needed, here keeping 1/2 size as per original code instructions
            ...
            {image && (
                <div>
                    ...
                    <button
                        ...
                        className="bg-red-500 text-white px-4 py-2 m-2 rounded hover:bg-red-600 transition-colors"
                    >
                        Invertir Colores
                    </button>
                    <button
                        onClick={() => applyFilter("brightness")}
                        className="bg-yellow-500 text-white px-4 py-2 m-2 rounded hover:bg-yellow-600 transition-colors"
                    >
                        Aumentar Brillo
                    </button>
                </div>
